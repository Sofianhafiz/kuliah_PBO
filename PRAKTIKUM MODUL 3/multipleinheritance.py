class Ayah:
    def __init__(self, nama_ayah):#class Ayah,karena urutan pewarisan class Anak(Ayah, Ibu).
...
#Class Anak mewarisi method dari Ayah dan Ibu, sehingga object budi bisa melakukan:pewarisan
    def memasak(self):
